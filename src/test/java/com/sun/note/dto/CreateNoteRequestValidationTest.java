...
class CreateNoteRequestValidationTest {
    ...
    void validRequest() {
        var request = CreateNoteRequest.of(VALID_CATEGORY_ID, VALID_TITLE, VALID_CONTENT);
    ...
    class CategoryIdValidation {
        ...
        void nullCategoryId() {
            var request = CreateNoteRequest.of(null, VALID_TITLE, VALID_CONTENT);
            Set<ConstraintViolation<CreateNoteRequest>> violations = validator.validate(request);
            assertThat(violations).isEmpty();
        }
    }
    ...
    class TitleValidation {
        ...
        void nullTitle() {
            var request = CreateNoteRequest.of(VALID_CATEGORY_ID, null, VALID_CONTENT);
            Set<ConstraintViolation<CreateNoteRequest>> violations = validator.validate(request);
        ...
        void blankTitle() {
            var request = CreateNoteRequest.of(VALID_CATEGORY_ID, "  ", VALID_CONTENT);
            Set<ConstraintViolation<CreateNoteRequest>> violations = validator.validate(request);
            assertThat(violations).isNotEmpty();
        }
        ...
        void titleAtMaxLength() {
            ...
            var request = CreateNoteRequest.of(VALID_CATEGORY_ID, title, VALID_CONTENT);
            Set<ConstraintViolation<CreateNoteRequest>> violations = validator.validate(request);
            assertThat(violations).isEmpty();
        }
    ...
    class ContentValidation {
        ...
        @DisplayName("null이면 실패")
        void nullContent() {
            var request = CreateNoteRequest.of(VALID_CATEGORY_ID, VALID_TITLE, null);
            Set<ConstraintViolation<CreateNoteRequest>> violations = validator.validate(request);
            assertThat(violations).isNotEmpty();
        }
        ...
        void contentAtMaxLength() {
            ...
            var request = CreateNoteRequest.of(VALID_CATEGORY_ID, VALID_TITLE, content);
            Set<ConstraintViolation<CreateNoteRequest>> violations = validator.validate(request);
            assertThat(violations).isEmpty();
        }
